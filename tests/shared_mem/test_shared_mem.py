#!/usr/bin/env python3
'''
PyTest - Test of Shared Memory datastore functions
...
# Mem DataStore
#
class Test_Shared_Mem_Datastore(TestBase):
    '''
    Test Class - Shared Mem Datastore
    ...
    def test_basic(self):
        ...
        Raises:
            AssertionError:
                when test fails
        '''
        _ds = DataStoreSharedMem(name="Basic", security="low")
    ...
    def test_encryption(self, options):
        ...
        _ds = DataStoreSharedMem(name="Encrypted", security="low", **_kwargs)
    ...
    def test_expiry(self):
        ...
        Raises:
            AssertionError:
                when test fails
        '''
        _ds = DataStoreSharedMem(name="Expiry", security="low")
